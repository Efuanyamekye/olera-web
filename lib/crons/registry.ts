...
export const CRON_REGISTRY: CronJob[] = [
  ...
  },
  {
    ...
    path: "/admin/family-comms",
    emailTypes: ["benefits_results_saved"],
    channels: ["email", "sms"],
