    ...
    >
        ...
        <div className="p-4 lg:p-6">
          {isLoggedIn ? (
            ...
            <>
              ...
              <div className="flex items-center gap-3 px-4 py-2.5 rounded-lg bg-gray-50 mb-6 lg:mx-20">
      ...
      {cardState === "expanded" && similarProviders.length > 0 && (
        <div className="p-4 lg:p-6">
          ...
          <div className="space-y-2 mb-4 lg:mx-20">
          ...
          {/* Card Stack */}
          <div className="relative mb-4 lg:mx-20">
